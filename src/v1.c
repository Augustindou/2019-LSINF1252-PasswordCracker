...
int main( int argc, char*argv[]){
	...
	if(argc==1){
		printf("the function need at least one argument\n");
		return -1;
	}
	
	int index = 1;
	
	//cas le nombre de thread est preciser
	char ch[] = "-t"; 
	...
	//encore à faire! cas ou pas le prochain n'est pas un -o mais l'argument de consonnes n'est pas bien respecter
